const galleries = {
    ...
    forets: [
      ...
      { src: 'images/montagnes/montagnes6.jpg', caption: "Chalet entouré d'une forêt enneigée" },
      { src: 'images/montagnes/montagnes3.jpg', caption: 'Fin de journée à Verbier' },
    ],
    montagnes: [
      ...
      { src: 'images/montagnes/montagnes24.jpg', caption: "Mont-Blanc vu depuis l'avion en fin de journée" },
      { src: 'images/montagnes/montagnes21.jpg', caption: "Le glacier d'Arolla entre deux sommets" },
    ...
    glaciers: [
      { src: 'images/montagnes/montagnes23.jpg', caption: "La fin du glacier d'Arolla" },
      { src: 'images/montagnes/montagnes22.jpg', caption: '' },
      { src: 'images/montagnes/montagnes18.jpg', caption: 'Le soleil matinal brillant sur le Glacier' },
